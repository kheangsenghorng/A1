  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="{{URL::to('/index')}}"><h2>Online Store <em>Website</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/index')}}">Home
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item active" href="{{URL::to('/about-us')}}">About Us</a>
                      <a class="dropdown-item" href="{{URL::to('/blog')}}">Blog</a>
                      <a class="dropdown-item" href="{{URL::to('/atestimonials')}}">Testimonials</a>
