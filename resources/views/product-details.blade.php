        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="{{URL::to('/product')}}">Products</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a href="{{URL::to('/product-detail')}}">view more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="{{URL::to('/product-details')}}"><h4>Omega bicycle</h4></a>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="{{URL::to('/product-details')}}"><h4>Nike Revolution 5 Shoes</h4></a>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="{{URL::to('/product-details')}}"><h4>Treadmill Orion Sprint</h4></a>
