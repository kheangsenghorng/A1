        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a href="{{URL::to('/product')}}">view more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="left-content">
              ...
              <a href="{{URL::to('/about-us')}}" class="filled-button">Read More</a>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a href="{{URL::to('/blog')}}">read more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a href="{{URL::to('/testimonials')}}">read more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          <div class="col-md-12">
            ...
            <div class="inner-content">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6 text-right">
                  <a href="{{URL::to('/contact')}}" class="filled-button">Contact Us</a>
                </div>
              </div>
            </div>
          </div>
